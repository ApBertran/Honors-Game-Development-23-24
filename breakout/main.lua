...
function love.load()
    ...
    -- generate quads from our spritesheet
    gFrames = {
...
--[[
    Loads high scores from a .lst file
]]
function loadHighScores()
    ...
    -- iterate over file of high scores to store them locally
